...
export const utilityReadings: import('@/types/pms').UtilityReading[] = [
  {
    id: 'UR001',
    property: 'Sunrise Tower',
    unit: 'A-1501',
    tenantName: 'Nguyễn Văn Minh',
    month: '01/2024',
    previousElectric: 1250,
    currentElectric: 1450,
    previousWater: 80,
    currentWater: 95,
    status: 'billed',
  ...
  },
  {
    ...
    tenantName: 'Trần Thị Hương',
    month: '01/2024',
    previousElectric: 900,
    currentElectric: 1100,
    previousWater: 50,
    currentWater: 62,
    status: 'billed',
    recordedDate: '2024-01-15',
  },
  {
    ...
    tenantName: 'Lê Hoàng Nam',
    month: '01/2024',
    previousElectric: 2100,
    currentElectric: 2100,
    previousWater: 120,
    currentWater: 120,
    status: 'recorded',
...
export const announcements: import('@/types/pms').Announcement[] = [
  {
    id: 'ANN001',
    title: 'Thông báo lịch bảo trì thang máy',
    content: 'Ban quản lý xin thông báo lịch bảo trì thang máy tòa A từ 8h00 đến 12h00 ngày 20/01/2024. Mong quý cư dân thông cảm.',
    date: '2024-01-18',
    recipients: 'Sunrise Tower',
    priority: 'high',
    sender: 'Ban Quản Lý',
  },
  {
    ...
    content: 'Ban quản lý kính chúc quý cư dân một năm mới An Khang Thịnh Vượng - Vạn Sự Như Ý!',
    date: '2024-01-01',
    recipients: 'all',
    priority: 'normal',
    sender: 'Ban Giám Đốc',
  ...
  {
    id: 'ANN003',
    title: 'Nhắc nhở về việc phân loại rác thải',
    content: 'Đề nghị quý cư dân thực hiện nghiêm túc việc phân loại rác tại nguồn theo quy định mới của thành phố.',
    date: '2024-01-10',
    recipients: 'all',
    priority: 'normal',
    sender: 'Ban Quản Lý',
  ...
  {
    id: 'ANN004',
    title: 'Cắt nước tạm thời để sửa chữa đường ống',
    content: 'Do sự cố đường ống cái, nước sẽ bị cắt tại khu vực Diamond Plaza từ 14h00 đến 17h00 hôm nay.',
    date: '2024-01-15',
    recipients: 'Diamond Plaza Apartment',
    priority: 'urgent',
    sender: 'Tổ Kỹ Thuật',
  }
];
